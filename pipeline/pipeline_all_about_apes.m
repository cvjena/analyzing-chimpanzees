    ...
    if ( b_visualize_results )
        ...
        for idx=1:size(str_detected_faces.i_face_regions,1)
            ...
            writeTextToImage ( s_est_attributes_combined{idx}, ...
                               [0.000 + str_detected_faces.i_face_regions(idx,1)/double(xsize) ... %+ str_detected_faces.i_face_regions(idx,4) ...
                                1.015 - str_detected_faces.i_face_regions(idx,2)/double(ysize)], ...
                                str_settings_text ...
                             );                            
