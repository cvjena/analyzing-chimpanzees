function s_values  = getStringSingleChimpansee ( s_fn, s_attribute )
% 
% BRIEF
    ...
    if ( i_numObjects == 1 )
        ...
        for idxAttribute=1:i_numAttributes
            if ( strcmp( mystruct.image_content.objects.object.attributes.attribute{idxAttribute}.key.Text, s_attribute) )
                s_values = [ s_values ; ...
                            mystruct.image_content.objects.object.attributes.attribute{idxAttribute}.value.Text...
                           ];
        ...
        for idxObject=1:i_numObjects
            ...
            b_foundAttribute = false;                    
            for idxAttribute=1:i_numAttributes
                if ( strcmp( mystruct.image_content.objects.object{idxObject}.attributes.attribute{idxAttribute}.key.Text, s_attribute) )
                    s_values = [ s_values ; ...
                                 mystruct.image_content.objects.object{idxObject}.attributes.attribute{idxAttribute}.value.Text...
                               ];
                    b_foundAttribute = true;
                    break;
                end
